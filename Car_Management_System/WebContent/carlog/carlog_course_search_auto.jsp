...
<div class = "popup_body">
		...
		<form name = "frm" method = "post" action = "carlog.do?command=carlog_course_select_auto&popup=yes&rownum=${rownum}">
		<select name="cour_divi">
			...
			<div class = "popup_box">
				...
				<tr>
						...
						<td><a onclick = "splaceSelectAuto('${cour.cour_no}','${rownum}')">${cour.s_place_name}</a></td>		
