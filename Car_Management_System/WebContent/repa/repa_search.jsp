		...
		<button id="ins_btn" type="submit" onclick="repaDateCheck()">조회</button>
			...
			id="content_cont-box1" style=display:block;>
				...
				<tr>		               
					...
					<input type = "hidden" name = "${repa.cent_no}cent_no" value  = "${repa.cent_no}">
					<%-- <input type = "hidden" name = "${repa.cent_name}cent_name" value  = "${repa.cent_name}"> --%>
					<input type = "hidden" name = "${repa.repa_s_date}repa_s_date" value  = "${repa.repa_s_date}">
					<input type = "hidden" name = "${repa.repa_e_date}repa_e_date" value  = "${repa.repa_e_date}">
					<input type = "hidden" name = "${repa.mechanic_name}mechanic_name" value  = "${repa.mechanic_name}">
					<input type = "hidden" name = "${repa.repa_fee}repa_fee" value  = "${repa.repa_fee}">
					<input type = "hidden" name = "${repa.repa_cont}repa_cont" value  = "${repa.repa_cont}">
